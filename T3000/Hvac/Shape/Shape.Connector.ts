...
class Connector extends BaseDrawingObject {
  ...
  LM_AddSVGTextObject(e, t, a) {
    ...
    void 0 === a &&
      ...
      Utils2.Pt2Rect(n, o);
    var s = e.CreateShape(ConstantData.CreateShapeType.RECT);
    ...
    var S = e.CreateShape(ConstantData.CreateShapeType.TEXT);
  ...
  CreateShape(e, t) {
    ...
    var c = e.CreateShape(ConstantData.CreateShapeType.POLYPOLYLINE);
    c.SetID(ConstantData.SVGElementClass.SHAPE);
    var u = e.CreateShape(ConstantData.CreateShapeType.POLYPOLYLINE);
  ...
  CreateActionTriggers(e, t, a, r) {
    var i,
      ...
      h,
      m = 0,
      C = e.CreateShape(ConstantData.CreateShapeType.GROUP),
    ...
    if (
      ...
      if (
        ...
        if (knobCopy = $.extend(!0, {
          ...
          w.cursorType = D,
            w.shapeType = ConstantData.CreateShapeType.OVAL,
            w.fillColor = 'white',
            w.fillOpacity = 0.01,
            w.strokeSize = 1,
            w.strokeColor = 'green'
      ...
      if (
        ...
        function (e) {
          ...
          w.shapeType = ConstantData.CreateShapeType.RECT,
          w.cursorType = d,
          S = ConstantData.ConnectorDefines.SEDA_NSkip;
          S < p;
          S++
    ...
    if (
      ...
      for (var _ = 0; _ < f.length; _++) {
        ...
        s.AddElement(S),
          p &&
          (
            c = GlobalData.optManager.svgDoc.CreateShape(ConstantData.CreateShapeType.POLYLINE)
          ) &&
          (
            c.SetPoints(y),
            c.SetFillColor('none'),

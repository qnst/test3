...
class GroupSymbol extends BaseSymbol {
  ...
  CreateShape(e, t) {
    return this.flags & ConstantData.ObjFlags.SEDO_NotVisible ? null : (
      ...
      e.CreateShape(ConstantData.CreateShapeType.SHAPECONTAINER)
    )
  }
  ...
  PostCreateShapeCallback(e, t, a, r) {
    ...
    if (!(this.flags & ConstantData.ObjFlags.SEDO_NotVisible)) {
      var i = e.CreateShape(ConstantData.CreateShapeType.GROUP);
      ...
      i.SetSize(s, l),
        t.isShape = !0;
      var L = e.CreateShape(ConstantData.CreateShapeType.RECT);
